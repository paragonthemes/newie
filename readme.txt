...
Newie WordPress Theme, Copyright 2017 Paragon Themes
Newie is distributed under the terms of the GNU General Public License v2
...
https://pixabay.com/en/woman-fashion-model-female-young-2542171/
https://pixabay.com/en/woman-model-sunlight-sunglasses-422706/


#### Changelog ####

## 1.0.4 - Feb 27 2018 ##
* Added Social Link on Author Widget
* Tested With Latest Verison of WordPress
* Some Minors css Changed.

## 1.0.3 - Feb 12 2018 ##
* Added Options Slider Caption Background Color
* Added Options for Show Slider Post on Category Post
* Fixed contact form 7 design
* Some minor CSS changed

## 1.0.2 - Feb 1 2018 ##
* Add update to pro
* Fixed primary color issues.
* Fixed menu issues.
